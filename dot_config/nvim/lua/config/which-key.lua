...
wk.register({
  ...
  ss = { "<cmd>lua MiniJump2d.start(MiniJump2d.builtin_opts.word_start)<cr>", "Jump to character" },
  sl = { "<cmd>lua MiniJump2d.start(MiniJump2d.builtin_opts.line_start)<cr>", "Jump to character" },
  st = { "<cmd>lua require('tshl').nodes()<cr>", "TS hint textobject" },
})
...
wk.register({
  ...
  f = {
    ...
    t = { "<cmd>UndotreeToggle<cr>", "Undo Tree Toggle" },
