# Generated by Powerlevel10k configuration wizard on 2019-11-11 at 16:55 CET.
...
# angled separators, blurred heads, sharp tails, 1 line, compact, many icons, fluent.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local       meta='%76F'   # grey foreground
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(wg|(.*tun))[0-9]*|(.*ztc.*)'
